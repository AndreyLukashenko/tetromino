...
public:
	...
	/*эта функци¤ вызываетс¤ каждую игровую итерацию, ее можно переопределить, в наследнике класса.
	в нее приходит deltaTime - разница во времени между предыдущей итерацией и этой, в секундах*/
	virtual void UpdateF(float deltaTime) {}
	/*эта функци¤ вызываетс¤ при нажатии клавиши на клавиатуре, в нее приходит код клавиши - btnCode.
